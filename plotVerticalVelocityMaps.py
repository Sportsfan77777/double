...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "verticalVelocityMaps",
                         help = 'save directory (default: verticalVelocityMaps)')
...
def make_plot(frame, show = False):
    ...
    cbar.set_label(r"$v_\mathrm{y}$", fontsize = fontsize, rotation = 270, labelpad = 25)
