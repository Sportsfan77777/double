...
Ha         =-0.25       #Hall parameter
Re         = 1e5        #Reynolds number for setting viscosity/diffusion
ReM        = 1e5        #Magnetic Reynolds number
...
stop_sim_time = 511          #in orbits (for convenience)
