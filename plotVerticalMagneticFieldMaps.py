...
def new_argument_parser(description = "Plot gas density maps."):
    ...
    # Files
    parser.add_argument('--dir', dest = "save_directory", default = "verticalMagneticFieldMaps",
...
def make_plot(frame, show = False):
    ...
    cbar.set_label(r"$B_\mathrm{z}$", fontsize = fontsize, rotation = 270, labelpad = 25)

    # Save, Show, and Close
    if version is None:
        save_fn = "%s/verticalMagneticFieldMap_%04d.png" % (save_directory, frame)
    else:
        save_fn = "%s/v%04d_verticalMagneticFieldMap_%04d.png" % (save_directory, version, frame)
